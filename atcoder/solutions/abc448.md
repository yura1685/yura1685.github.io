...
パット見計算量が厳しそうな問題。ただ $1 \le K \le 5$ という制約を見ると、$A$ の小さい順に $6$ 個の整数だけを確認すれば良いと分かる．
...
DFSをやれと問題文が言っていますね。頂点 $1$ から書かれている整数を記録しつつDFSをして，$2$ 個以上書かれている整数の個数が正ならばその頂点の答えはYesとなる．
...
を用いて繰り返し二乗法で簡単に計算できます（[類題1](https://atcoder.jp/contests/abc293/tasks/abc293_e), [類題2](https://atcoder.jp/contests/arc050/tasks/arc050_c), [類題3](https://atcoder.jp/contests/arc020/tasks/arc020_3)）．
